...
pub trait WithTypeIds {
    ...
    fn register_with_refs(map: &mut std::collections::HashMap<TypeId, RustSqlMapping>, single_sql: String) where Self: 'static  {
    ...
    fn register_sized_with_refs(_map: &mut std::collections::HashMap<TypeId, RustSqlMapping>, _single_sql: String) where Self: 'static  {
        ()
    }
    
    fn register_sized(_map: &mut std::collections::HashMap<TypeId, RustSqlMapping>, _single_sql: String) where Self: 'static  {
        ()
    }
    
    fn register_varlena_with_refs(_map: &mut std::collections::HashMap<TypeId, RustSqlMapping>, _single_sql: String) where Self: 'static  {
        ()
    }
    
    fn register_varlena(_map: &mut std::collections::HashMap<TypeId, RustSqlMapping>, _single_sql: String) where Self: 'static  {
        ()
    }

    fn register_array_with_refs(_map: &mut std::collections::HashMap<TypeId, RustSqlMapping>, _single_sql: String) where Self: 'static  {
        ()
    }
    
    fn register_array(_map: &mut std::collections::HashMap<TypeId, RustSqlMapping>, _single_sql: String) where Self: 'static  {
        ()
    }

    fn register(map: &mut std::collections::HashMap<TypeId, RustSqlMapping>, single_sql: String) where Self: 'static {
        let rust = core::any::type_name::<Self>();
        assert_eq!(
            map.insert(*Self::ITEM_ID, RustSqlMapping {
...
impl<T: 'static> WithSizedTypeIds<T>  {
    ...
    pub const OPTION_VEC_OPTION_ID: Lazy<Option<TypeId>> = Lazy::new(|| Some(TypeId::of::<Option<Vec<Option<T>>>>()));

    pub fn register_sized_with_refs(map: &mut std::collections::HashMap<TypeId, RustSqlMapping>, single_sql: String) where Self: 'static  {
...
impl<T: FromDatum + 'static> WithArrayTypeIds<T> {
    ...
    pub fn register_array_with_refs(map: &mut std::collections::HashMap<TypeId, RustSqlMapping>, single_sql: String) where Self: 'static  {
        WithArrayTypeIds::<T>::register_array(map, single_sql.clone());
        WithArrayTypeIds::<&T>::register_array(map, single_sql.clone());
        WithArrayTypeIds::<&mut T>::register_array(map, single_sql);
    }

    pub fn register_array(map: &mut std::collections::HashMap<TypeId, RustSqlMapping>, single_sql: String) {
        let set_sql = format!("{}[]", single_sql);
...
impl<T: Copy + 'static> WithVarlenaTypeIds<T> {
    ...
    pub fn register_varlena_with_refs(map: &mut std::collections::HashMap<TypeId, RustSqlMapping>, single_sql: String) where Self: 'static  {
        WithVarlenaTypeIds::<T>::register_varlena(map, single_sql.clone());
        WithVarlenaTypeIds::<&T>::register_varlena(map, single_sql.clone());
        WithVarlenaTypeIds::<&mut T>::register_varlena(map, single_sql);
    }

    pub fn register_varlena(map: &mut std::collections::HashMap<TypeId, RustSqlMapping>, single_sql: String) {
