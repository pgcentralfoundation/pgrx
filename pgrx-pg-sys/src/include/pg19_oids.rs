...
pub enum BuiltinOid {
    ...
    F_PG_GET_PUBLICATION_TABLES__TEXT_OID = 6435,
...
impl BuiltinOid {
    pub const fn from_u32(uint: u32) -> Result<BuiltinOid, NotBuiltinOid> {
        match uint {
            ...
            1261 => Ok(BuiltinOid::AuthMemRelationId),
            ...
            6435 => Ok(BuiltinOid::F_PG_GET_PUBLICATION_TABLES__TEXT_OID),
            ...
            6442 => Ok(BuiltinOid::OID8ARRAYOID),
            6437 => Ok(BuiltinOid::OID8OID),
            ...
            6491 => Ok(BuiltinOid::REGDATABASEARRAYOID),
            6490 => Ok(BuiltinOid::REGDATABASEOID),
