    ...
    fn to_tokens(&self, tokens: &mut proc_macro2::TokenStream) {
        let toks = match self {
            PositioningRef::FullPath(item) => quote! {
                ::pgx::utils::sql_entity_graph::positioning_ref::PositioningRef::FullPath(String::from(#item))
            },
            PositioningRef::Name(item) => quote! {
                ::pgx::utils::sql_entity_graph::positioning_ref::PositioningRef::Name(String::from(#item))
            },
        };
