...
-- src/lib.rs:45
CREATE SCHEMA IF NOT EXISTS tests; /* strings::tests */
...
-- src/lib.rs:49
-- strings::tests::test_it
CREATE OR REPLACE FUNCTION tests."test_it"() RETURNS void
STRICT
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'test_it_wrapper';
