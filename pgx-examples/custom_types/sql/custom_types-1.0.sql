...
-- src/complex.rs:50
CREATE SCHEMA IF NOT EXISTS tests; /* custom_types::complex::tests */

-- src/complex.rs:56
-- custom_types::complex::tests::test_known_animals_via_spi
CREATE OR REPLACE FUNCTION tests."test_known_animals_via_spi"() RETURNS void
STRICT
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'test_known_animals_via_spi_wrapper';
