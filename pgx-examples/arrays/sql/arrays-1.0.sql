...
-- src/lib.rs:117
CREATE SCHEMA IF NOT EXISTS tests; /* arrays::tests */
...
-- src/lib.rs:122
-- arrays::tests::test_vec_of_customtype
CREATE OR REPLACE FUNCTION tests."test_vec_of_customtype"() RETURNS void
STRICT
SET search_path TO @extschema@
LANGUAGE c /* Rust */
AS 'MODULE_PATHNAME', 'test_vec_of_customtype_wrapper';
