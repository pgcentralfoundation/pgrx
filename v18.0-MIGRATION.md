...
Why: schema matching now happens by `TYPE_IDENT`. The resolved form keeps the
type identity tied to the definition site and avoids drift between manual impls,
re-exports, and derive-generated metadata.
...
- a hand-written wrapper or custom datum type that your extension defines
