...
impl GucRegistry {
    pub fn define_bool_guc(
        ...
        context: GucContext,
        flags: GucFlags,
        assign_hook: Option<unsafe extern "C-unwind" fn(bool, *mut c_void) -> bool>,
    ) {
        unsafe {
    ...
    pub fn define_int_guc(
        ...
        context: GucContext,
        flags: GucFlags,
        assign_hook: Option<unsafe extern "C-unwind" fn(i32, *mut c_void) -> bool>,
    ) {
        unsafe {
    ...
    pub fn define_string_guc(
        ...
        context: GucContext,
        flags: GucFlags,
        assign_hook: Option<unsafe extern "C-unwind" fn(Option<&'static CStr>, *mut c_void) -> bool>,
    ) {
        unsafe {
    ...
    pub fn define_float_guc(
        ...
        context: GucContext,
        flags: GucFlags,
        assign_hook: Option<unsafe extern "C-unwind" fn(f64, *mut c_void) -> bool>,
    ) {
        unsafe {
    ...
    pub fn define_enum_guc<T>(
        ...
        context: GucContext,
        flags: GucFlags,
        assign_hook: Option<unsafe extern "C-unwind" fn(T, *mut c_void) -> bool>,
    ) where
        T: GucEnum<T> + Copy,
    {
        unsafe {
