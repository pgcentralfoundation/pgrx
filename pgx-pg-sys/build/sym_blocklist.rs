...
/// forcing pgx extensions to require a newer version of glibc than they might
/// otherwise. (As a result, this only covers exported functions, and not types,
/// constants, and other things we may not want in the `pgx-pg-sys` wrappers)
///
...
///
/// A future version of pgx will achieve this effect in a more complete and less
