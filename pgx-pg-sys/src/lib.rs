...
// This macro exists to force `$path` through a round of macro-expansion, so
// that it's usable in a `#[path]` attribute even if it is not a literal.
macro_rules! sys_mod {
    ($(#[$m:meta])* $v:vis mod $name:ident = $path:expr) => {
        $(#[$m])*
        #[cfg_attr(not(docsrs), path = $path)]
        $v mod $name;
    };
}
...
sys_mod! {
    #[cfg(feature = "pg11")]
    mod pg11 = concat!(env!("OUT_DIR"), "/pg11.rs");
}
sys_mod! {
    #[cfg(feature = "pg12")]
    mod pg12 = concat!(env!("OUT_DIR"), "/pg12.rs");
}
sys_mod! {
    #[cfg(feature = "pg13")]
    mod pg13 = concat!(env!("OUT_DIR"), "/pg13.rs");
}
sys_mod! {
    #[cfg(feature = "pg14")]
    mod pg14 = concat!(env!("OUT_DIR"), "/pg14.rs");
}
sys_mod! {
    #[cfg(feature = "pg15")]
    mod pg15 = concat!(env!("OUT_DIR"), "/pg15.rs");
}
...
sys_mod! {
    #[cfg(feature = "pg11")]
    mod pg11_oids = concat!(env!("OUT_DIR"), "/pg11_oids.rs");
}
sys_mod! {
    #[cfg(feature = "pg12")]
    mod pg12_oids = concat!(env!("OUT_DIR"), "/pg12_oids.rs");
}
sys_mod! {
    #[cfg(feature = "pg13")]
    mod pg13_oids = concat!(env!("OUT_DIR"), "/pg13_oids.rs");
}
sys_mod! {
    #[cfg(feature = "pg14")]
    mod pg14_oids = concat!(env!("OUT_DIR"), "/pg14_oids.rs");
}
sys_mod! {
    #[cfg(feature = "pg15")]
    mod pg15_oids = concat!(env!("OUT_DIR"), "/pg15_oids.rs");
}
